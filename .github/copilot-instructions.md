...
At the start of every conversation, after identifying the user, check which files exist in `users/[name]/`:
...
- Never write files outside `users/[name]/` except when creating that folder itself
